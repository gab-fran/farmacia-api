    ...
    static async todos(req: Request, res: Response): Promise<Response> {
     ...
     static async novo(req: Request, res: Response): Promise<Response> {
        ...
        try {
            ...
            const respostaModelo = await Medicamento.cadastrarMedicamento(dadosRecebidosCliente);
            ...
            return res.status(500).json({ mensagem: "Não foi possivel inserir o medicamento." });
        }
    }
     ...
     static async nomeMedicamento(req: Request, res: Response): Promise<Response> {
        try {
         ...
         static async principioMedicamento(req: Request, res: Response): Promise<Response> {
        try {
            ...
            const respostaModelo = await Medicamento.listarMedicamentoPrincipioAtivo(principioAtivo);
